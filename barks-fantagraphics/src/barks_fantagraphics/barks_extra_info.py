...
BARKS_EXTRA_INFO = {
    ...
    ' in one bundle."[/i]',
    Titles.WORM_WEARY: 'Garé Barks said about this story: [i]"For quite a while I just did some'
    " of the blacking. I remember one of the first stories I worked on was a Gyro Gearloose in"
    " which he caught some mammoth fish. Carl left all the scales for me to put on! I was so"
    " nervous because I'd never done anything that thousands and thousands of people would"
