...
BARKS_TITLE_INFO: List[ComicBookInfo] = [
    ...
    ComicBookInfo(Titles.FIREBUG_THE, True, Issues.FC, 108, 1, 1946, 19, 7, 1945),
    ...
    ComicBookInfo(Titles.TERROR_OF_THE_RIVER_THE, True, Issues.FC, 108, 1, 1946, 25, 1, 1946),
    ComicBookInfo(Titles.SEALS_ARE_SO_SMART, True, Issues.FC, 108, 1, 1946, 25, 1, 1946),
    ...
    ComicBookInfo(Titles.STRANGE_SHIPWRECKS_THE, False, Issues.US, 23, 9, 1958, 31, 12, 1957),
    ComicBookInfo(Titles.FABULOUS_TYCOON_THE, False, Issues.US, 23, 9, 1958, 9, 1, 1958),
    ...
    ComicBookInfo(Titles.FLYING_DUTCHMAN_THE, False, Issues.US, 25, 3, 1959, 20, 4, 1958),
    ...
    ComicBookInfo(Titles.KRANKENSTEIN_GYRO, False, Issues.US, 26, 6, 1959, 16, 6, 1958),
    ComicBookInfo(Titles.MONEY_CHAMP_THE, False, Issues.US, 27, 9, 1959, 12, 7, 1958),
    ComicBookInfo(Titles.HIS_HANDY_ANDY, False, Issues.US, 27, 9, 1959, 12, 7, 1958),
    ComicBookInfo(Titles.FIREFLY_TRACKER_THE, False, Issues.US, 27, 9, 1959, 15, 7, 1958),
    ComicBookInfo(Titles.PRIZE_OF_PIZARRO_THE, False, Issues.US, 26, 6, 1959, 11, 8, 1958),
    ...
    ComicBookInfo(Titles.GOOD_DEEDS_THE, False, Issues.CS, 229, 10, 1959, 15, 10, 1958),
    ComicBookInfo(Titles.BLACK_WEDNESDAY, False, Issues.CS, 230, 11, 1959, 30, 10, 1958),
    ...
    ComicBookInfo(Titles.DOG_SITTER_THE, False, Issues.CS, 238, 7, 1960, 7, 1, 1960),
    ComicBookInfo(Titles.MYSTERY_OF_THE_LOCH, False, Issues.CS, 237, 6, 1960, 15, 1, 1960),
    ComicBookInfo(Titles.VILLAGE_BLACKSMITH_THE, False, Issues.CS, 239, 8, 1960, 15, 1, 1960),
    ComicBookInfo(Titles.FRAIDY_FALCON_THE, False, Issues.CS, 240, 9, 1960, 15, 1, 1960),
    ComicBookInfo(Titles.ALL_AT_SEA, False, Issues.US, 31, 9, 1960, 12, 2, 1960),
    ComicBookInfo(Titles.FISHY_WARDEN, False, Issues.US, 31, 9, 1960, 16, 2, 1960),
    ComicBookInfo(Titles.TWO_WAY_LUCK, False, Issues.US, 31, 9, 1960, 26, 2, 1960),
    ComicBookInfo(Titles.BALLOONATICS, False, Issues.CS, 242, 11, 1960, 11, 3, 1960),
    ComicBookInfo(Titles.TURKEY_TROUBLE, False, Issues.CS, 243, 12, 1960, 11, 4, 1960),
    ComicBookInfo(Titles.MISSILE_FIZZLE, False, Issues.CS, 244, 1, 1961, 11, 4, 1960),
    ComicBookInfo(Titles.ROCKS_TO_RICHES, False, Issues.CS, 241, 10, 1960, 18, 4, 1960),
    ComicBookInfo(Titles.SITTING_HIGH, False, Issues.CS, 245, 2, 1961, 18, 4, 1960),
    ComicBookInfo(Titles.THATS_NO_FABLE, False, Issues.US, 32, 12, 1960, 12, 5, 1960),
