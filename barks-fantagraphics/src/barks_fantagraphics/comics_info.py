...
SERIES_INFO: Dict[str, SeriesInfo] = {
    ...
    "Salesman Donald": SeriesInfo(BIGD, SERIES_CS),
    "Snow Fun": SeriesInfo(BIGD, SERIES_CS),
    "The Duck in the Iron Pants": SeriesInfo(BIGD, SERIES_CS),
    "Kite Weather": SeriesInfo(GLEA, SERIES_CS),
    "Three Dirty Little Ducks": SeriesInfo(BIGD, SERIES_CS),
    "The Mad Chemist": SeriesInfo(SLEA, SERIES_CS),
    "Rival Boatmen": SeriesInfo(DIGI, SERIES_CS),
    "Camera Crazy": SeriesInfo(DIGI, SERIES_CS),
    "Farragut the Falcon": SeriesInfo(DIGI, SERIES_CS),
    "The Purloined Putty": SeriesInfo(DIGI, SERIES_CS),
    "High-wire Daredevils": SeriesInfo(DIGI, SERIES_CS),
    "Ten Cents' Worth of Trouble": SeriesInfo(GLEA, SERIES_CS),
    "Donald's Bay Lot": SeriesInfo(GLEA, SERIES_CS),
    "Thievery Afoot": SeriesInfo(GLEA, SERIES_CS),
