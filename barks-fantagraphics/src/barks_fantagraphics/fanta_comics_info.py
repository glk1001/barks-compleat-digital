...
SERIES_INFO: list[FantaSeriesInfo] = [
    ...
    # WDCS
    FantaSeriesInfo(Bt.VICTORY_GARDEN_THE, "?", SERIES_CS, FANTA_01),
    FantaSeriesInfo(Bt.RABBITS_FOOT_THE, "?", SERIES_CS, FANTA_01),
    FantaSeriesInfo(Bt.LIFEGUARD_DAZE, "?", SERIES_CS, FANTA_01),
    FantaSeriesInfo(Bt.GOOD_DEEDS, "?", SERIES_CS, FANTA_01),
    FantaSeriesInfo(Bt.LIMBER_W_GUEST_RANCH_THE, "?", SERIES_CS, FANTA_01),
    FantaSeriesInfo(Bt.MIGHTY_TRAPPER_THE, "?", SERIES_CS, FANTA_01),
    ...
    FantaSeriesInfo(Bt.MASTER_GLASSER_THE, DIGI, SERIES_CS, FANTA_23),
    ...
    #    FantaSeriesInfo(Bt.CHRISTMAS_CHA_CHA, GLEA, SERIES_MISC, FANTA_23),
